...
export default function Recruitment() {
        ...
        <>
          ...
          <div className="p-4 border-t border-gray-200">
            ...
            <button
              ...
              onClick={() => setTimelineLabour(labour)}
            >
  ...
  return (
    <div className="px-4 md:px-6 flex flex-col md:flex-row gap-4 md:gap-6 min-h-screen">
      {/* Left Sidebar - Requirements */}
      <div className="w-full md:w-1/6 rounded-lg md:p-4 md:overflow-y-auto md:max-h-[calc(100vh-2rem)]">
        {loading ? (
      ...
      {/* Right Content - Job Role Details */}
      <div className="w-full md:w-5/6 rounded-lg md:p-6 md:overflow-y-auto md:max-h-[calc(100vh-2rem)]">
        {loading ? (
