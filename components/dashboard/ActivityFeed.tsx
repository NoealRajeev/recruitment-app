...
const ActivityFeed = ({ activities }: ActivityFeedProps) => {
  return (
    <>
      <div className="flex items-center space-x-3 pl-4 pb-4 sm:pb-5">
        <div className="h-[1.25rem] sm:h-[1.5rem] w-[3px] bg-[#635372]/37 rounded-full" />
        <h2 className="text-base sm:text-lg font-semibold text-[#2C0053]">
